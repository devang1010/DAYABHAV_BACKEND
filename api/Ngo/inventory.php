...
if ($method == "GET") {
    ...
    // Notice the addition of inventory.created_at AS inventory_created_at to the SELECT statement
    $sql = "SELECT inventory.*, inventory.created_at AS inventory_created_at FROM inventory WHERE ngo_id = ?";
...
// Update status to completed in the inventory table 
elseif ($method == "POST") {
